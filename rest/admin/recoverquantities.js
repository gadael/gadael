...
function listController() {
    ...
    this.controllerAction = function() {
        this.jsonService(this.service('admin/recoverquantities/list'));
    };
}
...
function getController() {
    ...
    this.controllerAction = function() {
        this.jsonService(this.service('admin/recoverquantities/get'));
    };
}
...
function createController() {
    ...
    this.controllerAction = function() {
        ...
        controller.jsonService(
            controller.service('admin/recoverquantities/save', {
...
function deleteController() {
    ...
    var controller = this;
    this.controllerAction = function() {
        this.jsonService(this.service('admin/recoverquantities/delete', {
